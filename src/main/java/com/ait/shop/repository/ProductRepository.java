...
Как работает технология Spring Data JPA?
    ...
    4. В этом классе она сама пишет стандартные методы по работе с БД, например
    findAll, findById, save и т д. И в этих методах она сама прописывает нужные
    SQL запросы в БД
    5. Spring создает объект этого класса, который написала технология JPA и
    помещает его в Spring Context
 */
